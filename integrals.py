...
def test_constant():
    case_1 = {
        "term_structure": torch.arange(5, dtype=torch.float64),
        "coef_structure": torch.zeros(4, dtype=torch.float64),
